...
distSAR_phylo.dev.nest <- distSAR(coords=betadev_env_scale[,7:8], y=betadev_env_scale[,11], env=betadev_env_scale[,c(17:22, 24)], start=200, end=1000, co.increment=250) #300 km
